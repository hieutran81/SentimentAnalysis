...
def fit_cnn():
    ...
    conv_0 = Conv2D(num_filters, kernel_size=(filter_sizes[0], embedding_dim), padding='valid',
                    kernel_initializer='normal', activation='relu', input_shape= input_shape, kernel_regularizer=regularizers.l2(0.01))(batch_norm)
    ...
    output = Dense(units=3, activation='softmax', kernel_regularizer=regularizers.l2(0.1))(dropout)
